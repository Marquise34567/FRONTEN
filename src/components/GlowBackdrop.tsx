    ...
    <div className="relative min-h-screen overflow-hidden bg-background">
      <div className="pointer-events-none absolute inset-0 z-0 [contain:paint]" aria-hidden="true">
        <div
          ...
          style={{
            background:
              "radial-gradient(65% 48% at 48% 8%, rgba(212,175,55,0.26), transparent 70%), radial-gradient(58% 56% at 82% 24%, rgba(192,132,252,0.18), transparent 74%), hsl(240 15% 5%)",
          }}
        />
        ...
        {staticMode ? (
          <div
            ...
            style={{
              background: "radial-gradient(circle, rgba(212,175,55,0.42) 0%, rgba(192,132,252,0.16) 52%, transparent 78%)",
            }}
          />
        ) : (
          <>
            <motion.div
              ...
              style={{
                background: "radial-gradient(circle, rgba(212,175,55,0.45) 0%, rgba(192,132,252,0.15) 56%, transparent 78%)",
              }}
            ...
            <motion.div
              ...
              style={{
                background: "radial-gradient(circle, rgba(192,132,252,0.42) 0%, rgba(212,175,55,0.12) 52%, transparent 76%)",
              }}
