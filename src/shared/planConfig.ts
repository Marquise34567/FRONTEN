...
export const PLAN_CONFIG: Record<PlanTier, PlanConfig> = {
  founder: {
    ...
    features: [
      ...
      "AI hook finder + dead-air cutter",
      "Post-render retention feedback (hooks, risks, actions)",
      "Vertical Clip Builder (30s / 60s clips)",
      "Batch download all clips",
      "Advanced caption studio (styles, fonts, animation, color, position)",
      "Live caption placement preview",
      "Ultra + Retention-focused pacing modes",
  ...
  free: {
    ...
    features: [
      ...
      "10 renders / month",
      "AI hook finder + dead-air cutter",
      "Post-render retention feedback summary",
      "Watermark",
      "Standard queue",
      "Subtitles: 1 preset",
      "Auto zoom max 1.10",
